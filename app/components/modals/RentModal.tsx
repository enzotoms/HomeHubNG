...
if (step === STEPS.LOCATION) {
  bodyContent = (
    <div className="flex flex-col gap-8">
      <Heading 
         title= "Where is you property located?"
...
if (step === STEPS.INFO) {
  bodyContent = (
    <div className="flex flex-col gap-8">
      ...
      <Counter 
        title="Guests"
        subtitle="How many guest are allowed to lodge?"
        value={guestCount}
    ...
    <Counter 
        title="Bathrooms"
        subtitle="How many bathrooms are in the facility?"
        value={bathroomCount}
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="Show your guests what your property looks like!"
        />
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="Give your guests a feel of what your property looks like!"
        />
       {/* @ts-ignore */}
          <Input
            id="title"
